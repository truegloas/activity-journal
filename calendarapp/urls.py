...
urlpatterns = [
    ...
    path('calendar/doing/note/', doing_note_view, name='doing_note'),
    path('calendar/doing/note/<int:note_id>', doing_note_edit_text_view, name='doing_note_edit_text'),
    path('calendar/doing/note/<int:note_id>', doing_note_edit_image_view, name='doing_note_edit_image'),
